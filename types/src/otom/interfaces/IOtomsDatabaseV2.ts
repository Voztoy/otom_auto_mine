...
export interface IOtomsDatabaseV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "activeUniverses"
...
export interface IOtomsDatabaseV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IOtomsDatabaseV2;
  waitForDeployment(): Promise<this>;

  interface: IOtomsDatabaseV2Interface;
