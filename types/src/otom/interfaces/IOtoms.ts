...
export interface IOtomsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "annihilate"
      | "balanceOf"
...
export interface IOtoms extends BaseContract {
  connect(runner?: ContractRunner | null): IOtoms;
  waitForDeployment(): Promise<this>;

  interface: IOtomsInterface;
