...
export interface OtomsDatabaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "activeUniverses"
...
export interface OtomsDatabase extends BaseContract {
  connect(runner?: ContractRunner | null): OtomsDatabase;
  waitForDeployment(): Promise<this>;

  interface: OtomsDatabaseInterface;
